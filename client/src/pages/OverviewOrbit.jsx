...
export default function OverviewOrbit() {
  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="mb-6">
        <h2 className={`text-2xl font-bold ${theme.heading}`}>Orbit</h2>
        <p className={`text-sm mt-1 ${theme.subtext}`}>
          Interactive map of the live workspace across clients, publishing, analytics, AI support, and admin controls.
        </p>
      </div>
